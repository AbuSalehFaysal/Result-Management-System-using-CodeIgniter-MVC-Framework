...
<div class="row">
    <div class="col-md-10" style="margin: 50px 20px 50px 50px;">
        <section class="panel b-a" style="min-height: 400px;">
            ...
            <?php } ?>
            <frameset>
                <frame name="header" scrolling="no">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="btn btn-info btn-sm" href="<?php echo base_url(); ?>add_marks/<?php echo $students->stu_roll; ?>">Add</a>
                                    <a type="button" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>delete/<?php echo $students->stu_roll; ?>">Delete</a>
                                    <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>view/<?php echo $students->stu_roll; ?>">View</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php else: ?>
