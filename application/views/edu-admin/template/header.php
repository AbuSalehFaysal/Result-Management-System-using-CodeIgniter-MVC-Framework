...
<html lang="en" class="app">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $this->session->name; ?></title>
        ...
        <section class="vbox">
            <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
                <div class="navbar-header aside-md dk">
                    ...
                    <a href="#" class="navbar-brand"> <img src="../assets/images/logo.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs">Result Database</span> </a>
                            ...
                            <section class="w-f scrollable">
                                <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                    <div class="clearfix wrapper dk nav-user hidden-xs">
                                        <div class="dropdown">
                                            <a href="<?php echo base_url(); ?>edu-admin/logout" class="" data-toggle=""> <span class="thumb avatar pull-left m-r"> <img src="../assets/images/a0.png" class="dker" alt="..."> <i class="on md b-black"></i> </span> <span class="hidden-nav-xs clear"> <span class="block m-t-xs"> <strong class="font-bold text-lt"><?php echo $this->session->name; ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Logout</span> </span>
                                        </a>
